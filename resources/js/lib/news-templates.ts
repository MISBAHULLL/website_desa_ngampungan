...
export const newsContentTemplates: NewsTemplate[] = [
    {
        ...
        icon: '🌾',
        description:
            'Template untuk panen raya, kerja bakti, musyawarah, atau acara kemasyarakatan.',
        category: 'Pertanian',
        titlePlaceholder:
            'Contoh: Kerja Bakti Gotong Royong Membersihkan Saluran Irigasi Dusun',
        excerptPlaceholder:
            'Warga bersama tokoh masyarakat bergotong royong menjaga kebersihan lingkungan desa.',
        content: [
    ...
    },
    {
        ...
        icon: '🏗️',
        description:
            'Template untuk perbaikan jalan, saluran air, balai desa, atau fasilitas publik.',
        category: 'Pembangunan',
        titlePlaceholder:
            'Contoh: Perbaikan Jalan Lingkungan Dusun Dimulai Secara Bertahap',
        excerptPlaceholder:
            'Pekerjaan difokuskan pada titik jalan strategis untuk memperlancar mobilitas warga.',
        content: [
    ...
    },
    {
        ...
        icon: '🏥',
        description:
            'Template untuk posyandu lansia/balita, pencegahan stunting, atau pemeriksaan gratis.',
        category: 'Kesehatan',
        titlePlaceholder:
            'Contoh: Program Posyandu Lansia & Balita Rutin Digelar di Balai Desa',
        excerptPlaceholder:
            'Pemerintah desa dan kader kesehatan membuka pemeriksaan rutin bagi warga.',
        content: [
    ...
    },
    {
        ...
        icon: '🛍️',
        description:
            'Template untuk mempromosikan produk lokal, kerajinan, wisata, atau usaha warga.',
        category: 'UMKM & Budaya',
        titlePlaceholder:
            'Contoh: Produk Kerajinan Bambu Ngampungan Mulai Diminati Pasar Luar Daerah',
        excerptPlaceholder:
            'Inovasi produk lokal warga memadukan kualitas tinggi dan motif tradisional.',
        content: [
