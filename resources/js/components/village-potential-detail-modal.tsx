        ...
        <>
                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto [scrollbar-width:thin] [scrollbar-color:#cbd5e1_transparent] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
                        ...
                        <div className="p-6 sm:p-8 space-y-8">
                            ...
                            {/* Section 7: Footer Action Bar (Without 'Buka Halaman Penuh') */}
            ...
            {selectedProduct && (
                <div
                    role="dialog"
                    aria-modal="true"
                    className="fixed inset-0 z-60 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md animate-in fade-in duration-200"
                    onClick={() => setSelectedProduct(null)}
                >
                    <div
                        className="relative w-full max-w-2xl overflow-hidden rounded-3xl bg-white p-5 sm:p-6 shadow-2xl border border-white/40 animate-in zoom-in-95 duration-200"
                        onClick={(e) => e.stopPropagation()}
                    >
