...
type VillageServiceCreateProps = {
    categories: CategoryOption[];
};

export default function VillageServiceCreate({
    categories,
}: VillageServiceCreateProps) {
                ...
                <header className="flex flex-col justify-between gap-4 border-b border-sidebar-border/70 pb-6 md:flex-row md:items-end">
                    <div>
                        ...
                        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                            Definisikan jenis layanan baru beserta persyaratan
                            dan berkas pendukung yang harus dilengkapi warga.
                        </p>
                    </div>
                        ...
                        <div className="grid gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="contoh: Penduduk desa"
                                    className="min-h-11 w-full rounded-lg border border-input bg-transparent px-3 text-sm transition outline-none focus:border-emerald-600 focus:ring-3 focus:ring-emerald-600/15"
                                />
                                {errors.audience && (
                                    <p className="mt-1 text-xs text-red-500">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="contoh: Kaur Pelayanan Desa"
                                    className="min-h-11 w-full rounded-lg border border-input bg-transparent px-3 text-sm transition outline-none focus:border-emerald-600 focus:ring-3 focus:ring-emerald-600/15"
                                />
                            </div>
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="contoh: identity-card"
