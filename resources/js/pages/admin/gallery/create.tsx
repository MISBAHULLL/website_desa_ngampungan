...
import { index as galleryIndex, store as galleryStore } from '@/actions/App/Http/Controllers/Admin/GalleryController';
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 space-y-5 shadow-xs">
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                {errors.album && <p className="mt-1 text-xs text-red-600">{errors.album}</p>}
                            </div>
                        </div>
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                            <div>
                                <label htmlFor="image_alt" className="block text-xs font-bold text-foreground uppercase tracking-wider">
                            ...
                            <div>
                                <label htmlFor="captured_at" className="block text-xs font-bold text-foreground uppercase tracking-wider">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            ...
                            <span>{processing ? 'Menyimpan...' : 'Simpan & Unggah Foto'}</span>
                        </button>
                        <Link
                            href={galleryIndex()}
