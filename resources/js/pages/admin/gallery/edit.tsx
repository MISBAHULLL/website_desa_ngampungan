...
import { index as galleryIndex, update as galleryUpdate } from '@/actions/App/Http/Controllers/Admin/GalleryController';
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 space-y-5 shadow-xs">
                        {/* Image Preview */}
                        <div className="flex items-center gap-4 rounded-xl bg-muted/40 p-4 border border-sidebar-border/70">
                            <div className="size-20 shrink-0 overflow-hidden rounded-lg border border-sidebar-border bg-muted">
                                <img src={photo.image_path} alt={photo.image_alt || photo.title} className="size-full object-cover" />
                            </div>
                            <div className="text-xs text-muted-foreground">
                                <p className="font-bold text-foreground">Pratinjau Foto Saat Ini</p>
                                <p className="mt-1 line-clamp-1">{photo.image_path}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Alam & Pertanian">Alam & Pertanian</option>
                                </select>
                            </div>

                            <div>
                                <label htmlFor="album" className="block text-xs font-bold text-foreground uppercase tracking-wider">
                                    Nama Album *
                                </label>
                                <input
                                    id="album"
                        ...
                        <div>
                            <label htmlFor="caption" className="block text-xs font-bold text-foreground uppercase tracking-wider">
                        ...
                        <div className="grid gap-5 sm:grid-cols-2 pt-2 border-t border-sidebar-border/70">
                            <div>
                                <label htmlFor="image" className="block text-xs font-bold text-foreground uppercase tracking-wider">
                            ...
                            <div>
                                <label htmlFor="image_url" className="block text-xs font-bold text-foreground uppercase tracking-wider">
                                    Atau Ganti URL Foto
                                </label>
                                <input
                                    id="image_url"
                        ...
                        <div className="flex items-center gap-2 pt-2">
                            ...
                            />
                            <label htmlFor="is_featured" className="text-xs font-bold text-foreground">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            ...
                            <span>{processing ? 'Menyimpan...' : 'Perbarui Foto'}</span>
                        </button>
                        <Link
                            href={galleryIndex()}
