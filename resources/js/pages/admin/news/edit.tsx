...
import { AlertCircle, ArrowLeft, FileText, Plus, Star } from 'lucide-react';
...
export default function AdminNewsEdit({
    ...
    const [videoUrl, setVideoUrl] = useState(newsItem.video_url || '');
    const [videoFile, setVideoFile] = useState<File | null>(null);
    const [removeVideo, setRemoveVideo] = useState(false);
    const [removeImage, setRemoveImage] = useState(false);
    const [mediaType, setMediaType] = useState<'photo' | 'video'>(
        newsItem.video_path || newsItem.video_url ? 'video' : 'photo',
    );
                                ...
                                <div className="space-y-6 lg:col-span-4">
                                    ...
                                    {mediaType === 'video' && (
                                        <AdminVideoUploadField
                                            currentVideo={newsItem.video_path}
                                            videoUrl={videoUrl}
